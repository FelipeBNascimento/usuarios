package com.javanauta.usuario.infraesctruture.security;
...
public class JwtUtil {
    ...
    private final String secretKey = "EstaEumaChaveSecretaMuitoLongaEseguraParaHS256";
    ...
    public String extraiToken(String token) {
    ...
    public boolean validateToken(String token, String username) {
        ...
        final String extractedUsername = extraiToken(token);
